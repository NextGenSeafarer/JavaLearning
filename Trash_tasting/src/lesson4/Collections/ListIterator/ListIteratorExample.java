...
public class ListIteratorExample {
    public static void main(String[] args) {
       ...
       /*
       «адача на проверку палиндрома - т.е. читаетс€ ли слово с начала и с конца одинаково или нет
       ...
       ћинусы: работает только с латиницей!
     ...
     */
        ...
        String a = "Sum summus mus"; // я - сильнейша€ мышь с латинского
